...
1. Team Members: Chad Parker, Michael Kagan
2. App Name: Ruler
3. App Description (3-5 sentences):

    Converts between many different units of distance measurement. Select your unit, enter the amount, and see results. You can select your most-used favorite units for easy access.
    
4. Your #1 Customer (Who would use your app? Why now?)
 
    Everyone! People traveling to a different country, carpenters, teachers, etc.
    
5. Github code repository: https://github.com/iOSPT5-BW1/Unit-Converter-I
6. Github Project/Trello Board: https://www.notion.so/3a63b0e503ae4d6486c527e086ce0ed3?v=96433557bcb24134bef273f71d89da9e
...
1. Convert between measurement units
2. Customize units into favorites
3. Customize decimal places
4. Setting to enable rare units
