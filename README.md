...
1. Team Members: `James McDougall`
2. App Name: `Streamer Keeper`
3. App Description (3-5 sentences):

`This app is supposed to keep track of what shows you have and haven't watched. Depending on the streaming service you would like to use it for.`
    
4. Your #1 Customer (Who would use your app? Why now?)
 
 `Literally anyone and their grandma. This app would be used by anyone who uses any type of video streaming service.`
    
5. Github code repository: `https://github.com/james-mcdougall/Streamer-Keeper`
6. Github Project/Trello Board: `https://trello.com/b/k0wXJpNy/streamer-keeper`
...
1. `This will keep an organized list of all the shows and movies that a person watches on a streaming service`
2. `This will make the user's life a bit easier because they will be able to go through an up to date list of all the movies/shows that they are wanting to see `
3. `I am hoping with the final feature of this, that I will be able to make this app a little more fun then what is normally feasable. I want to gamify this app. Thus making people WANT to use it.`
