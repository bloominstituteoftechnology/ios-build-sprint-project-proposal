...
1. Team Members: Michael Kagan + Chad Parker
2. App Name: Ruler
3. App Description (3-5 sentences):

    User can select default measurment preference (imperial or metric) and type in a value for a unit (ex miles) and have it auto populate a value for the other units.
    
4. Your #1 Customer (Who would use your app? Why now?)
 
    Maybe people traveling to a different country, and need to convert distances
...
2. Default units (imperial or metric)
3. favorite units would appear at the top
