...
6. Github Project/Trello Board: `https://trello.com/b/Fsp989ZS/mortgage-calculator`
...
1. `<Feature 1: Better understand the financial situation/investment they are walking into`
2. `<Feature 2: Imediate ability to see raw data and visuals of mortgage`
3. `<Feature 3: Ability to cross reference different interst rates`
