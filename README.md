...
1. Team Members: `Vici Shaweddy`
2. App Name: `Worn Out`
3. App Description (3-5 sentences):

    `Worn Out app lets you the mileage that you put on your running shoes. You will be able to know when it's time for you to replace your running shoes with Worn Out. You can track multiple pairs of shoes. It's automatically sync with your running apps.`
    
4. Your #1 Customer (Who would use your app? Why now?)
 
    `Runners or whoever wants to track their shoe miles.`
...
1. `Tracking miles automatically from running apps or HealthKit or manually adding the miles`
2. `Reminding users to replace their old shoes`
3. `Showing the shoe timeline`
