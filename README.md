...
4. Your #1 Customer (Who would use your app? Why now?)
    Anyone who trains for endurance sports using the 80/20 rule. There really isn't a good tool out there for this.
5. Github code repository: `<Create a Github Project>`
6. Github Project/Trello Board: https://trello.com/b/FYUuI4EB/80-20-heart-rate-tracker
