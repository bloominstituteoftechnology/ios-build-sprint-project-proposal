...
1. Team Members: `Scott Harris`
2. App Name: `Clamtown crossfit`
3. App Description (3-5 sentences):

    `An app for a crossfit gym to upload at home workouts and users to see, watch, do, and log at home workouts`
    
4. Your #1 Customer (Who would use your app? Why now?)
 
    `Members of the gym`
    
5. Github code repository: `https://github.com/scottharris86/Clamtown-Crossfit`
6. Github Project/Trello Board: `https://github.com/scottharris86/Clamtown-Crossfit/projects/1`
...
1. `Watch and log at home workouts`
2. `stay active and healthy at home during quarantine`
3. `coaches to upload videos an new workouts each day`
