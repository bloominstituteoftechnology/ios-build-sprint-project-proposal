...
1. Team Members: `David Williams & Marc Jacques`
2. App Name: Ad-Libs
3. App Description (3-5 sentences):
The app will allow a user to enter words to be placed in a short story, depending on the word type (noun, verb, etc.) to fill in the place of certain words, to create a whacky version of the story (from a choice of several stories), also allowing the re-reading of previously ad-libbed stories with some selection controls.
    
    
4. Your #1 Customer (Who would use your app? Why now?)
 
    Someone who is looking to have fun with others in being silly, someone who is bored for a few minutes or likes word games
...
1. `choose words that will be palced into sentences in place of other words >`
2. `give the customer a choice to choose between stories 
3. choose a story from a list of previous ad-libs to share
