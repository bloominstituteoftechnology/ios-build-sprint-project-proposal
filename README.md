...
1. `Track Healthy Habits`
2. `Send reminders and notifications when it's time to practice one of the above`
3. `Encourage in-app exploration for self-care, empowerment, and stress-relief`
